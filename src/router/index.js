...
import RegHospital from "../components/page/RegHospital.vue"; //医院注册信息
import HospitalHomepage from "../components/page/HospitalHomepage.vue"; // 医院首页
import hositalmanagement from "../components/page/hositalmanagement.vue"; //团队预定
import inquire from "../components/page/management/inquire.vue"; // 券状态查询
import group from "../components/page/management/group.vue"; //验证团购券
Vue.use(Router);
...
export default new Router({
  routes: [{
    ...
    {
      path: "/RegHospital", // 医院注册信息
      name: "RegHospital",
      component: RegHospital
    },
    {
      path: "/HospitalHomepage", //医院首页
      name: "HospitalHomepage",
      component: HospitalHomepage
    },
    {
      path: "/hositalmanagement", // 医院首页里面的项目管理
      name: "hositalmanagement",
      component: hositalmanagement,
      children: [{
          path: "/hositalmanagement/inquire", // 券状态查询
          component: inquire
        },
        {
          path: "/hositalmanagement/group", // 验证团购券
          component: group
        }
      ]
    }
